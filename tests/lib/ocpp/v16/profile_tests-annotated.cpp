...
// execute: ./libocpp_unit_tests --gtest_filter=ProfileTestsAnnotated.*
...
class ProfileTestsAnnotated : public stubs::DbTestBase {
protected:
...
TEST_F(ProfileTestsAnnotated, DailyRecurringNotValidYet) {
...
TEST_F(ProfileTestsAnnotated, DailyRecurringAlmostValid) {
    const std::int32_t connector_id{1};
...
TEST_F(ProfileTestsAnnotated, DailyRecurringDuring) {
    const std::int32_t connector_id{1};
    DateTime session_start("2024-01-01T07:00:00Z");
...
TEST_F(ProfileTestsAnnotated, DailyRecurringApproachingEnd) {
    const std::int32_t connector_id{1};
    DateTime session_start("2024-01-01T07:00:00Z");
...
TEST_F(ProfileTestsAnnotated, DailyRecurringNextDay) {
    const std::int32_t connector_id{1};
    DateTime session_start("2024-01-01T07:00:00Z");
...
TEST_F(ProfileTestsAnnotated, DailyRecurringNextDayStart) {
    const std::int32_t connector_id{1};
...
TEST_F(ProfileTestsAnnotated, DailyRecurringApproachingInvalid) {
    const std::int32_t connector_id{1};
    DateTime session_start("2024-01-05T07:00:00Z");
